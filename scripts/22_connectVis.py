...
class CustomShifterStep(cstp.customShifterMainStep):
    ...
    def run(self):
        ...
        for attr in ["jacketCtl_vis", "hairCtl_vis", "facialCtl_vis", "collarCtl_vis", "bootsCtl_vis"]:
            cmds.setAttr(target + "." + attr, 0)

        for source in ["tail_C0_ik0_ctl", "F_C0_ik0_ctl"]:
            cmds.setAttr(source + ".visibility", l=False)
            cmds.setAttr(source + ".visibility", 0)
        return
